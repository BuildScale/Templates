...
try:
    ...
    from buildscale.utils import log
    #from buildscale.utils import CriticalError, UnknownError
    from buildscale.utils import validate_host, validate_port, validate_user, validate_password
    from buildscale.utils import isStr
    from buildscale import CLI
    from buildscale import RestNagiosPlugin
