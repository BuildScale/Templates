...
LABEL org.opencontainers.image.description="NAME" \
      ...
      org.opencontainers.image.url="https://ghcr.io/BuildScale/REPO" \
      org.opencontainers.image.documentation="https://hub.docker.com/r/buildscale/REPO" \
      ...
      #org.opencontainers.image.url="https://hub.docker.com/r/buildscale/REPO" \
...
RUN apk add --no-cache curl && \
    curl -sS https://raw.githubusercontent.com/BuildScale/DevOps-Scripts/master/clean_caches.sh | sh && \
    apk del curl && \
...
#
#   https://github.com/BuildScale/GitHub-Actions/blob/master/.github/workflows/codeartifact_secret.yaml
#
...
# nosemgrep: dockerfile.best-practice.prefer-copy-over-add.prefer-copy-over-add
ADD https://api.github.com/repos/BuildScale/DevOps-Python-tools/git/refs/heads/master /.git-hashref
